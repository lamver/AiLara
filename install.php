...
<script>
    jQuery(function ($) {
        ...
        $(document).ready(function() {
            ...
            Showcase();
            ShowcaseCarousel();
            if( (typeof NcenceDigitalThemeOptions != 'undefined') && (NcenceDigitalThemeOptions.enable_ajax == "1") ){
                AjaxLoad();
            } else {
                PageLoadNoAjax();
            }
...
---------------------------------------------------*/
        function AjaxLoad() {
            ...
            TweenLite.set(a, {
                ...
                function l(t, o) {
                    e = !0, $("body").addClass("page-is-changing"), $(".nce-cover-layer").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
                        r(t, o), n = t, $(".nce-cover-layer").off("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend")
                    }), d() || (r(t, o), n = t)
                }

                function r(n, l) {
                    n = "" == n ? "index.html" : n;
                    var r = $('<div class="nce-main-content "></div>');
                    r.load(n + " .nce-main-content > *", function(c) {
                        $("main").html(r);
                        var s = c.match(/<title[^>]*>([^<]+)<\/title>/)[1];
                        $("head title").html(s), $("html, body").scrollTop(0);
                        var p = d() ? 30 : 0;
                        setTimeout(function() {
                            $("body").removeClass("page-is-changing"), $(".nce-cover-layer").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
                                e = !1, $(".nce-cover-layer").off("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend")
...
---------------------------------------------------*/
    ...
    function ContactMap() {
        ...
        if( jQuery('#map_canvas').length > 0 ){
            ...
            var map_address 			= 'Moscow'
            var map_zoom				= 16;
            var marker_title 				= 'Hello Friend!';
            var marker_text				= 'Here we are. Come to drink a coffee!';
            var map_type					= google.maps.MapTypeId.NCENCE;

            if( typeof NcenceMapOptions != 'undefined' ){

                map_marker_image 	= NcenceMapOptions.map_marker_image;
                map_address 			= NcenceMapOptions.map_address;
                map_zoom				= Number(NcenceMapOptions.map_zoom);
                marker_title 				= NcenceMapOptions.marker_title;
                marker_text				= NcenceMapOptions.marker_text;
                if( NcenceMapOptions.map_type == 0 ){

                    map_type = google.maps.MapTypeId.NCENCE;
                }
                else{
    ...
    function InitContactMap() {
        ...
        if( jQuery('#map_canvas').length > 0 ){
            ...
            if (typeof google != 'undefined' && typeof google.maps != 'undefined'){
                ...
                var map_api_key = '';
                if( typeof NcenceMapOptions != 'undefined' ){
                    map_api_key = 'key=' + NcenceMapOptions.map_api_key;
                }
...
`);
    ...
    let ditheringTexture = createTextureAsync('https://ncence.com/wp-content/themes/digital/images/LDR_LLL1_0.png?dl=0');
