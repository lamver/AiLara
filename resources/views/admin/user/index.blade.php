            ...
            <tr>
                ...
                <td>
                    <div class="d-flex" role="group" aria-label="Basic example">
                        <a href="{{route('admin.user.edit', $user->id)}}" class="btn btn-light" title="{{__('edit')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        &nbsp;
                        <a href="{{route('admin.user.show', $user->id)}}" class="btn btn-info" title="{{__('see_profile')}}" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <form method="post" action="{{route('admin.logInAsUser')}}">
                            ...
                            <button class="btn btn-warning" title="{{__('login_as_user')}}">
